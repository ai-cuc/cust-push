// The number of worker threads for this process.
// Note,
// if this variable is set after the thread pool starts
// it will be ignored and the thread pool will still be restricted to the default size of 4.
// ref: https://github.com/oracle/node-oracledb/blob/master/doc/api.md#numberofthreads
